...
@section('container')
    <div class="container p-0" style="min-height: 100vh">
        <h1 class="d-flex justify-content-center p-3 m-0 text-white">Book List</h1>
        <div class="row d-flex justify-content-center">
            <p class="border-bottom border-3 m-0 p-0" style="width: 30%"></p>
        </div>
        <div class="row d-flex justify-content-evenly m-0 mt-4">
            @if (count($books) < 1)
                <h1 class="d-flex justify-content-center p-3 m-0 text-secondary fs-5">No Books Found!!!</h1>
            @else
